...
package com.leonard.healthmanager.WalkandStep.services;
...
public abstract class AbstractStepDetectorService extends IntentService implements SensorEventListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String BROADCAST_ACTION_STEPS_DETECTED = "com.leonard.healthmanager.STEPS_DETECTED";

    public static final String EXTENDED_DATA_NEW_STEPS = "com.leonard.healthmanager.NEW_STEPS";

    public static final String EXTENDED_DATA_TOTAL_STEPS = "com.leonard.healthmanager.TOTAL_STEPS";
