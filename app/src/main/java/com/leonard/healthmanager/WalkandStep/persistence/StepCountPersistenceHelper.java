...
public class StepCountPersistenceHelper {
    ...
    public static final String BROADCAST_ACTION_STEPS_SAVED = "com.leonard.healthmanager.STEPS_SAVED";
    public static final String BROADCAST_ACTION_STEPS_UPDATED = "com.leonard.healthmanager.STEPS_UPDATED";
    public static final String BROADCAST_ACTION_STEPS_INSERTED = "com.leonard.healthmanager.STEPS_INSERTED";
