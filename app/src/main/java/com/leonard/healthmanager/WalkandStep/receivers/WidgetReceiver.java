...
public class WidgetReceiver extends AppWidgetProvider {
    public static final String PAUSE_STEP_DETECTION_ACTION = "com.leonard.healthmanager.WalkandStep.PAUSE_STEP_DETECTION_ACTION";
    public static final String CONTINUE_STEP_DETECTION_ACTION = "com.leonard.healthmanager.WalkandStep.CONTINUE_STEP_DETECTION_ACTION";
